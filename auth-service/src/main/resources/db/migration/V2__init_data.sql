...
VALUES ('cb2f0983-5b96-4d4d-8e61-12286d75ac54', 'UserGroup1', 'Viewer', FALSE,
        '{"usergrouppermissions":{"permissionItems":[{"permissionitem":{"applicationId":"app.user","actions":["CREATE","UPDATE","READ","DELETE"],"uuid":"70ac16be-aeae-4ded-b7db-79d20e9ffe24"}}]}}',
       ...
       ('7ac08049-1709-4757-9250-bcf16c32f57a', 'UserGroup3', 'Viewers group with view-only permissions', FALSE,
        '{"usergrouppermissions":{"permissionItems":[{"permissionitem":{"applicationId":"app.user","actions":["READ"],"uuid":"70ac16be-aeae-4ded-b7db-79d20e9ffe24"}},{"permissionitem":{"applicationId":"app.movie","actions":["READ","CREATE"],"uuid":"70ac16be-aeae-4ded-b7db-79d20e9ffe24"}}]}}',
        'system', 'system', NOW(), NOW());
