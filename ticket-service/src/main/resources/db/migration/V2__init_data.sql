...
VALUES ('tk1', 'event-001', 'Spring Concert 2025', 'A1', 'type-std-001', 'TICKET-0001', NULL,
        NULL, '2025-06-10 19:00:00', 'AVAILABLE', NULL, 'system', 'system', NOW(), NOW()),
       ('tk2', 'event-001', 'Spring Concert 2025', 'A2', 'type-std-001', 'TICKET-0002', NULL,
        NULL, '2025-06-10 19:00:00', 'AVAILABLE', NULL, 'system', 'system', NOW(), NOW()),
       ('tk3', 'event-001', 'Spring Concert 2025', 'VIP-1', 'type-vip-001', 'TICKET-0003', NULL,
        NULL, '2025-06-10 19:00:00', 'AVAILABLE', NULL, 'system', 'system', NOW(), NOW());
...
INSERT INTO ticketorderlink (id, ticket_id, order_id, purchase_time, create_user, change_user, create_timestamp,
                             change_timestamp)
VALUES (UUID(), 'tk1', 'order-001', NOW(), 'system', 'system', NOW(), NOW());
