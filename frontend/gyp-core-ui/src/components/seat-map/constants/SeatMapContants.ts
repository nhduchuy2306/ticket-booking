export const TableColors = Object.freeze({
    ROUND: Object.freeze({key: 'ROUND', color: '#8BC34A'}),
    RECTANGLE: Object.freeze({key: 'RECTANGLE', color: '#9C27B0'})
});
...
export const SeatSizes = Object.freeze({
    SMALL: Object.freeze({key: 'SMALL', size: 30}),
    MEDIUM: Object.freeze({key: 'MEDIUM', size: 40}),
    LARGE: Object.freeze({key: 'LARGE', size: 50}),
    SUPER_LARGE: Object.freeze({key: 'SUPER_LARGE', size: 60}),
});
