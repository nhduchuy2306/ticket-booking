...
import { TicketTypeResponseDto } from "../../../models/generated/ticket-service-models";
import { CategoryService } from "../../../services/Event/CategoryService";
import { EventService, EventServiceAdapter } from "../../../services/Event/EventService.ts";
import { SeasonService } from "../../../services/Event/SeasonService";
import { TicketTypeService } from "../../../services/Event/TicketTypeService";
import { VenueMapService } from "../../../services/Event/VenueMapService";
import { SaleChannelService } from "../../../services/SaleChannel/SaleChannelService";
import { DateUtils } from "../../../utils/DateUtils.ts";

interface EventBasicInformationFormProps {
    mode: string;
    showBackButton?: boolean;
    showActionButtons?: boolean;
    isStepperFlow?: boolean;
    onStepperSubmit?: (values: EventRequestDto, selectedVenueMap?: VenueMapResponseDto) => void;
}

export interface EventBasicInformationFormHandle {
    submit: () => void;
}

const EventBasicInformationForm =
        forwardRef<EventBasicInformationFormHandle, EventBasicInformationFormProps>(({
                                                                                         mode,
                                                                                         showBackButton = true,
                    ...
                    const handleFormSubmit = async (values: any) => {
                        ...
                        try {
                            ...
                            if (isStepperFlow) {
                                onStepperSubmit?.(adaptedValues, venueMaps.find(venueMap => venueMap.id === adaptedValues.venueMapId));
                                return;
                            }
...
EventBasicInformationForm.displayName = "EventBasicInformationForm";

export default EventBasicInformationForm;